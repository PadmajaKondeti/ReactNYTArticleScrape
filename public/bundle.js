...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
		...
		getSearchResults: function getSearchResults(searchTerm, beginDate, endDate) {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement('input', { type: 'text', className: 'form-control text-center', id: 'beginDate', onChange: this.handleChange, required: true }),
						React.createElement('br', null),
						React.createElement(
							'h4',
							{ className: '' },
